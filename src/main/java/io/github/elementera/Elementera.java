...
class Public implements Loggers {
	public static final Item PROTIUM = new Protium();
	public static final Item DEUTERIUM = new Deuterium();
	public static final Item TRITIUM = new Tritium();
	public static final Item He2 = new He2();
	public static final Item He3 = new He3();
	public static final Item He4 = new He4();
	public static final Item He5 = new He5();
	public static final Item He6 = new He6();
	public static final Item He7 = new He7();
	public static final Item He8 = new He8();
	public static final Item He9 = new He9();
	public static final Item He10 = new He10();
	public static final Item Li6 = new Li6();
	public static final Item Li7 = new Li7();
	public static final Item Be7 = new Be7();
	public static final Item Be8 = new Be8();
	public static final Item Be9 = new Be9();
	public static final Item Be10 = new Be10();
	public static final Item B6 = new B6();
	public static final Item B7 = new B7();
	public static final Item B8 = new B8();
	public static final Item B9 = new B9();
	public static final Item B10 = new B10();
	public static final Item B11 = new B11();
	public static final Item B12 = new B12();
	public static final Item B13 = new B13();
	public static final Item B14 = new B14();
	public static final Item B15 = new B15();
	public static final Item B16 = new B16();
	public static final Item B17 = new B17();
	public static final Item B18 = new B18();
	public static final Item B19 = new B19();
	public static final Item C8 = new C8();
	public static final Item C9 = new C9();
	public static final Item C10 = new C10();
	public static final Item C11 = new C11();
	public static final Item C12 = new C12();
	public static final Item C13 = new C13();
	public static final Item C14 = new C14();
	public static final Item C15 = new C15();
	public static final Item C16 = new C16();
	public static final Item C17 = new C17();
	public static final Item C18 = new C18();
	public static final Item C19 = new C19();
	public static final Item C20 = new C20();
	public static final Item C21 = new C21();
	public static final Item C22 = new C22();
	...
	public static final ItemGroup GAS = FabricItemGroupBuilder.create(
			...
			.appendItems(itemStacks -> {
				itemStacks.add(new ItemStack(PROTIUM));
				itemStacks.add(new ItemStack(He4));
				itemStacks.add(new ItemStack(DEUTERIUM));
				itemStacks.add(new ItemStack(TRITIUM));
				itemStacks.add(new ItemStack(He2));
				itemStacks.add(new ItemStack(He3));
				itemStacks.add(new ItemStack(He5));
				itemStacks.add(new ItemStack(He6));
				itemStacks.add(new ItemStack(He7));
				itemStacks.add(new ItemStack(He8));
				itemStacks.add(new ItemStack(He9));
				itemStacks.add(new ItemStack(He10));
			})
			.build();
	public static final ItemGroup METALS = FabricItemGroupBuilder.create(
			...
			.appendItems(itemStacks -> {
				itemStacks.add(new ItemStack(Li7));
				itemStacks.add(new ItemStack(Be8));

				itemStacks.add(new ItemStack(Li6));
				itemStacks.add(new ItemStack(Be7));
				itemStacks.add(new ItemStack(Be9));
				itemStacks.add(new ItemStack(Be10));
			})
			.build();
	public static final ItemGroup NONMETALS = FabricItemGroupBuilder.create(
			...
			.appendItems(itemStacks -> {
				itemStacks.add(new ItemStack(B6));
				itemStacks.add(new ItemStack(B7));
				itemStacks.add(new ItemStack(B7));
				itemStacks.add(new ItemStack(B8));
				itemStacks.add(new ItemStack(B9));
				itemStacks.add(new ItemStack(B10));
				itemStacks.add(new ItemStack(B11));
				itemStacks.add(new ItemStack(B12));
				itemStacks.add(new ItemStack(B13));
				itemStacks.add(new ItemStack(B14));
				itemStacks.add(new ItemStack(B15));
				itemStacks.add(new ItemStack(B16));
				itemStacks.add(new ItemStack(B17));
				itemStacks.add(new ItemStack(B18));
				itemStacks.add(new ItemStack(B19));
				itemStacks.add(new ItemStack(C8));
				itemStacks.add(new ItemStack(C9));
				itemStacks.add(new ItemStack(C10));
				itemStacks.add(new ItemStack(C11));
				itemStacks.add(new ItemStack(C12));
				itemStacks.add(new ItemStack(C13));
				itemStacks.add(new ItemStack(C14));
				itemStacks.add(new ItemStack(C15));
				itemStacks.add(new ItemStack(C16));
				itemStacks.add(new ItemStack(C17));
				itemStacks.add(new ItemStack(C18));
				itemStacks.add(new ItemStack(C19));
				itemStacks.add(new ItemStack(C20));
				itemStacks.add(new ItemStack(C21));
				itemStacks.add(new ItemStack(C22));
			})
			.build();
	public Public() {
