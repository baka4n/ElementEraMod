...
import io.github.elementera.common.items.*;
...
class ModItems {
	...
	public static void lithium() {/*lithium*/chooseReg(lithium_4, Li4);chooseReg(lithium_5, Li5);chooseReg(lithium_6, Li6);chooseReg(lithium_7, Li7);chooseReg(lithium_8, Li8);chooseReg(lithium_9, Li9);chooseReg(lithium_10, Li10);chooseReg(lithium_11, Li11);chooseReg(lithium_12, Li12);chooseReg(lithium_13, Li13); }
	...
	public static void boron() {/*boron*/chooseReg(boron_7, B7);chooseReg(boron_8, B8);chooseReg(boron_9, B9);chooseReg(boron_10, B10);chooseReg(boron_11, B11);chooseReg(boron_12, B12);chooseReg(boron_13, B13);chooseReg(boron_14, B14);chooseReg(boron_15, B15);chooseReg(boron_16, B16);chooseReg(boron_17, B17);chooseReg(boron_18, B18);chooseReg(boron_19, B19); }
	...
	public static void neon() {/*neon*/chooseReg(neon_16, Ne16);chooseReg(neon_17, Ne17);chooseReg(neon_18, Ne18);chooseReg(neon_19, Ne19);chooseReg(neon_20, Ne20);chooseReg(neon_21, Ne21);chooseReg(neon_22, Ne22);chooseReg(neon_23, Ne23);chooseReg(neon_24, Ne24);chooseReg(neon_25, Ne25);chooseReg(neon_26, Ne26);chooseReg(neon_27, Ne27);chooseReg(neon_28, Ne28);chooseReg(neon_29, Ne29);chooseReg(neon_30, Ne30);chooseReg(neon_31, Ne31);chooseReg(neon_32, Ne32);chooseReg(neon_33, Ne33);chooseReg(neon_34, Ne34); }
	public static void sodium() {
		/*sodium*/chooseReg(sodium_18, Na18);chooseReg(sodium_19, Na19);
	}
